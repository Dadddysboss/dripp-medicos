...
import { fmtCurrency, formatDateTime, LS_KEYS, baseUnitsFor, formatPackagingShort } from '../config.js';
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
          <div class="flex items-center justify-between mb-4">
            <div>
              ...
              <div class="text-[11px] text-slate-500 dark:text-slate-400">Below custom low stock threshold — quick +1 box</div>
            </div>
